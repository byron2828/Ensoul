...
namespace OneKeyToWin_AIO_Sebby
{
    ...
    {
        private static string OktwNews = "Successful Porting by ajvavjuhani";
        ...
        private static void OnGameLoad()
        {
            ...
            about.Add(new MenuSeparator("0", "OneKeyToWin© by Sebby port by ajvavjuhani"));
            about.Add(new MenuSeparator("1", "visit ensoul"));
            about.Add(new MenuSeparator("2", "DONATE: adnan.mne@gmail.com"));
            ...
            pred.Add(new MenuList("Qpred", "Q Prediction MODE", new[] { "Common prediction", "OKTW© PREDICTION", "SPrediction press F5 if not loaded", "Exory prediction" }, 0, ObjectManager.Player.CharacterName));
            pred.Add(new MenuList("QHitChance", "Q Hit Chance", new[] { "Very High", "High", "Medium" }, 0, ObjectManager.Player.CharacterName));
            pred.Add(new MenuList("Wpred", "W Prediction MODE", new[] { "Common prediction", "OKTW© PREDICTION", "SPrediction press F5 if not loaded", "Exory prediction" }, 0, ObjectManager.Player.CharacterName));
            pred.Add(new MenuList("WHitChance", "W Hit Chance", new[] { "Very High", "High", "Medium" }, 0, ObjectManager.Player.CharacterName));
            pred.Add(new MenuList("Epred", "E Prediction MODE", new[] { "Common prediction", "OKTW© PREDICTION", "SPrediction press F5 if not loaded", "Exory prediction" }, 0, ObjectManager.Player.CharacterName));
            pred.Add(new MenuList("EHitChance", "E Hit Chance", new[] { "Very High", "High", "Medium" }, 0, ObjectManager.Player.CharacterName));
            pred.Add(new MenuList("Rpred", "R Prediction MODE", new[] { "Common prediction", "OKTW© PREDICTION", "SPrediction press F5 if not loaded", "Exory prediction" }, 0, ObjectManager.Player.CharacterName));
            ...
            if (pred.GetValue<MenuList>("Qpred").Index == 1 ||
                pred.GetValue<MenuList>("Wpred").Index == 1 ||
                pred.GetValue<MenuList>("Epred").Index == 1 ||
                pred.GetValue<MenuList>("Rpred").Index == 1)
            {
		...
		case "Quinn":
            ...
            {
                Game.Print("<font size='30'>OneKeyToWin</font> <font color='#b756c5'>by Sebby port by ajvavjuhani</font>");
